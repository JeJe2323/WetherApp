$(document).ready(function(){
    //0aa3025aa3c9443f3b66e8d5279c821f
    //https://api.openweathermap.org/data/2.5/weather?q=busan&appid=0aa3025aa3c9443f3b66e8d5279c821f


    var cityName = [];  //버튼 클릭시 또는 검색바에서 입력 후 엔터를 누를 시, 도시명 데이터를 수집한다.
    console.log(cityName);  //[]

    var myAPI = `0aa3025aa3c9443f3b66e8d5279c821f`;
